...
class MultiTRVSyncMonitor:
    def __init__(self, host, port, username, password, sensor_table):
        self.host = host
        self.port = port
    ...
    def _build_room_groups(self, sensor_table) -> Dict[str, List[str]]:
        ...
        for room in rooms_id:
            ...
            # Only add rooms with multiple TRVs
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            # Store the raw Zigbee temperature value for comparison
    ...
    def sync_to_peers(self, source_device, room, mode_changed=False, temp_changed=False, new_mode=None, new_temp_raw=None):
        ...
        try:
            ...
            sync_key = f"{source_device}_{time.time()}"
            ...
            try:
                ...
                del self.sync_in_progress[sync_key]
...
if __name__ == "__main__":
    ...
    # Initialize monitor with dynamic room groups
    monitor = MultiTRVSyncMonitor(MQTT_HOST, 1883, 'ga_zigbee2mqtt', 'ga_zigbee2mqtt', sensor_table)
